...
func NewLocalClient(logger log.Logger, app types.Application) abcicli.Client {
...
var _ proxy.ClientCreator = (*localClientCreator)(nil)
...
func NewLocalClientCreator(logger log.Logger, app types.Application) proxy.ClientCreator {
...
func (l *localClientCreator) NewABCIClient() (abcicli.Client, error) {
	return NewLocalClient(l.logger, l.app), nil
}
